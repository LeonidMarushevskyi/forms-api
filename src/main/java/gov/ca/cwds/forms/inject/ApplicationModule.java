...
/**
 * Bootstraps and configures the CWDS RESTful FORMS_UNIT_OF_WORK-API application.
 *
 * @author CWDS TPT-2 Team
 */

public class ApplicationModule<T extends FormsApiConfiguration> extends AbstractModule {
