...
import static gov.ca.cwds.forms.Constants.API.SYSTEM_INFORMATION_PATH;
...
public class SystemInformationResource {
  ...
  public SystemInformationDTO get() {
    ...
    SortedMap<String, HealthCheck.Result> healthChecks = environment.healthChecks()
        .runHealthChecks();
    systemInformationDTO.setFormsDb(
        getHealthCheckResultDTO(healthChecks.get(Constants.UnitOfWork.FORMS_UNIT_OF_WORK)));
