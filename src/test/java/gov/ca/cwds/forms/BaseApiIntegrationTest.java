...
import gov.ca.cwds.forms.web.rest.utils.TestModeUtils;
...
public abstract class BaseApiIntegrationTest {
  ...
  private static final String configFile = "config/test-forms-api.yml";

  @ClassRule
  public static final DropwizardAppRule<FormsApiConfiguration> appRule =
      new DropwizardAppRule<FormsApiConfiguration>(
          FormsApiApplication.class, ResourceHelpers.resourceFilePath(configFile)) {
  ...
  protected static DatabaseHelper getFormsDatabaseHelper() {
    DataSourceFactory dataSourceFactory = appRule.getConfiguration().getFormsDataSourceFactory();
