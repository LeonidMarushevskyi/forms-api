...
public class RestClientTestRule implements TestRule {
  ...
  private final DropwizardAppRule<FormsApiConfiguration> dropWizardApplication;

  private Client client;
  private ObjectMapper mapper;
  private String token;

  public RestClientTestRule(DropwizardAppRule<FormsApiConfiguration> dropWizardApplication) {
